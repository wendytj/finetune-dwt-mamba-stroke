...
def apply_colora_to_model(
    ...
    if target_modules is None:
        target_modules = ["pe_branches", "pm_branches", "conv_branch", "mb_gsf.proj", "latent_encoder"]
    ...
    for full_name, module in model.named_modules():
        for child_name, child in module.named_children():
            if isinstance(child, nn.Conv2d):
                ...
                if any(target in child_full_name for target in target_modules):
                    modules_to_replace.append((module, child_name, child, child_full_name))
